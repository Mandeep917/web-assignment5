...
* 
*  Name: Mandeep Kaur Student ID: 148986219 Date: 23/07/2022
*
*  Online (Heroku) Link:  https://intense-harbor-91578.herokuapp.com/
*  github link: https://github.com/Mandeep917/web-app-assign5.git
* 
...
app.get("/courses", (req, res) => {
    ...
    console.log("courses called successfully" )
    }).catch(err => {
